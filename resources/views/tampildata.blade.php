...
<html lang="en">
  ...
  <body>
    <h1 class = "text-center mb-4">Ubah Data Obat</h1>
        <div class="container">
            <div class="row justify-content-center">
                <div class = 'col-8'>
                    <div class="card">
                        <div class="card-body">
                            <form action = "/updatedata/{{$data->kode}}" method = "POST">
                                @csrf 
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="hargaSatuan" value = "{{ $data->hargaSatuan }}">
                                </div>
